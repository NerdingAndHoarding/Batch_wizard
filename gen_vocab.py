...
CPP_OUT = Path("vocab_JAMES_BROWN.cpp")
H_OUT   = Path("vocab_JAMES_BROWN.h")
...
GUARD_TOP = (
    "#ifndef _TALKIE_VOCAB_JAMES_BROWN_H\n"
    "#define _TALKIE_VOCAB_JAMES_BROWN_H \n"
)

GUARD_BOTTOM = "#endif // _TALKIE_VOCAB_VOCAB_JAMES_BROWN_H\n"
